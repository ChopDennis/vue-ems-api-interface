    ...
    border-radius: 7px;"
          >
            <div class="col-4">
              ...
              <p class="real-time-value">
                {{ output.lists[0].value }}
              </p>
              <p class="real-time-title">
                {{ output.lists[8].name }}
              </p>
              <p class="real-time-value">
                {{ output.lists[8].value }}
              </p>
            </div>
            <div class="col-4">
              <p class="real-time-title">
              ...
              <p class="real-time-value">
                {{ output.lists[1].value }}
              </p>
              <p class="real-time-title">
                {{ output.lists[9].name }}
              </p>
              <p class="real-time-value">
                {{ output.lists[9].value }}
              </p>
            </div>
            <div class="col-4">
              <p class="real-time-title">
                {{ output.lists[11].name }}
              </p>
              <p class="real-time-value">
                {{ output.lists[11].value }}
              </p>
              <p class="real-time-title">
                {{ output.lists[10].name }}
              </p>
              <p class="real-time-value">
                {{ output.lists[10].value }}
              </p>
            </div>
          </div>
          <div class="row p-3">
